...
ud_zanahoria varchar(15) not null,
ud_cubo_leche varchar(15) not null,
ud_pescao varchar(15) not null,
ud_cubo_agua varchar(15) not null,
id_usuario int not null,
...
insert into item values (1, '1 ud', '3 ud', '6 ud', '0', 1);
insert into item values (2, '7 ud', '7 ud', '7 ud', '10 ud', 2);
insert into item values (3, '4 ud', '1 ud', '2 ud', '4 ud', 3);
insert into item values (4, '9 ud', '11 ud', '8 ud', '12 ud', 4);
insert into item values (5, '1 ud', '5 ud', '6 ud', '8 ud', 5);
